...
<div class="header">
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <a href="{{ url('products/'.$product->id) }}"><img src="{{ asset(explode('|', $product->image)[0]) }}" height="250" width="200"></a>
                <h4>{{ $product->name }}</h4>
                <div class="rating">
        ...
        <div>
            <ul class="pagination pagination-lg">
              <li class="page-item btn" aria-current="page">
                <span class="page-link">{{ $products->links('vendor.pagination.default') }}</span>
              </li>
            </ul>
        </div>
    </div>
